...
export default function AdministrativeConsoleVerifyAccount({ configs }: AppConfigs) {
	...
	return (
		<AuthLayout meta={metaData} title="Confirm Password Reset Operation" heading="Verify your email">
