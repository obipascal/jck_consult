...
export default function SignUpPage({ configs }: AppConfigs) {
	...
	return (
		<MainLayout meta={metaData} siteConfigs={configs} title="Sign Up">
			<InitTailwindUI />
							...
							<div className="grid grid-cols-1">
								...
								<div className="px-4 md:px-0">
									<div className="xs:mx-6 xs:py-10 md:p-12 flex items-center justify-center">
										<Formik initialValues={initData} onSubmit={_handleSubmit} validationSchema={signUpValidatorScheme}>
											{({ handleChange, values }) => (
												<Form className="space-y-6 rounded-lg shadow p-5">
													<p className="mb-2 font-bold text-2xl">Sign Up</p>
													<p className="mb-4">You must have an account before you can enroll in a course</p>
