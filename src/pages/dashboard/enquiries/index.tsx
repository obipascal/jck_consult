...
export default function DashboardEnquiries({ configs }: DashboardProps) {
	...
	return (
		<DashboardLayout meta={metaData} title="Customers Enquiries" pageName="Enquiries" siteConfigs={configs}>
			<DashboardContent title="Customers Enquiries" component={components}>
