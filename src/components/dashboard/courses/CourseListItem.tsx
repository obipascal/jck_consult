...
import { CalendarIcon, CheckIcon, ChevronDownIcon, CurrencyDollarIcon, LinkIcon, MapPinIcon, PencilIcon, TrashIcon } from "@heroicons/react/20/solid"
...
export default function CourseListItem({ courseName }: CourseListItemProps) {
	return (
		<div className="lg:flex lg:items-center lg:justify-between bg-white shadow-log p-3 rounded mb-4">
			<div className="min-w-0 flex-1">
				<h2 className="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">{courseName}</h2>
