...
export default function CourseListItem({ showInfo = true, showActions = true, status, image, courseId, courseName, courseAmount, courseLastModified }: CourseListItemProps) {
	...
	return (
		<>
			<div className="flex lg:items-center lg:justify-between bg-white shadow-log p-3 rounded mb-4">
				<div className="p-3 w-fit">
					<Image src={image ?? ""} width={100} height={100} className="rounded-md md:h-20 md:w-40" alt="" />
				</div>
				<div className=" w-full lg:flex lg:items-center lg:justify-between">
					<div className="min-w-0 flex-1">
						<h2 className="text-md hover:text-blue font-bold leading-7 text-gray-900 sm:truncate   sm:tracking-tight">{courseName}</h2>
						{showInfo && (
