// icon:bag-check-fill | Bootstrap https://icons.getbootstrap.com/ | Bootstrap
import * as React from "react"

function IconBagCheckFill(props: React.SVGProps<SVGSVGElement>) {
	return (
...
export default IconBagCheckFill
