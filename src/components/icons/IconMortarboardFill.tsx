// icon:mortarboard-fill | Bootstrap https://icons.getbootstrap.com/ | Bootstrap
import * as React from "react"

function IconMortarboardFill(props: React.SVGProps<SVGSVGElement>) {
	return (
...
export default IconMortarboardFill
