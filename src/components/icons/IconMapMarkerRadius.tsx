// icon:map-marker-radius | Material Design Icons https://materialdesignicons.com/ | Austin Andrews
import * as React from "react"

function IconMapMarkerRadius(props: React.SVGProps<SVGSVGElement>) {
	return (
...
export default IconMapMarkerRadius
